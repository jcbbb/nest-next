    ...
    <div className="mt-20 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <form onSubmit={onSignup} className="space-y-6 mt-10" action="#" method="POST">
        ...
        <div>
          ...
          <div className="mt-2">
            <input id="password" name="password" placeholder="complicated-passphrase" type="password" autoComplete="current-password" required className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 disabled:opacity-70 disabled:pointer-events-none" />
          </div>
        </div>
